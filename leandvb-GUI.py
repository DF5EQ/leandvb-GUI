...
def dlg_settings():
    ...
    lbl_standard   = ttk.Label   (tab_leansdr,           text="DVB standard")
    lb2_standard   = ttk.Label   (tab_leansdr,           text=" (--standard) : ")
    cmb_standard   = ttk.Combobox(tab_leansdr, width=10, textvariable=standard, state="readonly")
    ...
    lbl_standard_1 = ttk.Label    (frm_dvb_options, text="standard")
    cmb_standard_1 = ttk.Combobox (frm_dvb_options, width=10, textvariable=standard, state="readonly")
    cmb_standard_1 ["values"] = ("DVB-S","DVB-S2")
    cmb_standard_1.bind("<<ComboboxSelected>>", set_visibility_dvb_options)
    lbl_standard_1.grid (row=0, column=0, sticky=E)
    cmb_standard_1.grid (row=0, column=1, sticky=W)
    ...
    lbl_fec_1.grid (row=2, column=0, sticky=E)
    cmb_fec_1.grid (row=2, column=1, sticky=W)
    ...
    lbl_modcods_1.grid (row=2, column=0, sticky=E)
    ent_modcods_1.grid (row=2, column=1, sticky=W)
    lb2_modcods_1.grid (row=2, column=2, sticky=W)
    ...
    lbl_framesizes_1.grid (row=3, column=0, sticky=E)
    ent_framesizes_1.grid (row=3, column=1, sticky=W)
    lb2_framesizes_1.grid (row=3, column=2, sticky=W)
    ...
    lbl_nhelpers_1.grid (row=6, column=0, sticky=E)
    ent_nhelpers_1.grid (row=6, column=1, sticky=W)
    ...
    lbl_standard  .grid (row=1, column=0, sticky=E)
    lb2_standard  .grid (row=1, column=1, sticky=E)
    cmb_standard  .grid (row=1, column=2, sticky=E)
    lbl_inpipe    .grid (row=2, column=0, sticky=E)
    lb2_inpipe    .grid (row=2, column=1, sticky=E)
    ent_inpipe    .grid (row=2, column=2, sticky=W)
    lb3_inpipe    .grid (row=2, column=3, sticky=W)
    ...
    lbl_nhelpers  .grid (row=5, column=0, sticky=E)
    lb2_nhelpers  .grid (row=5, column=1, sticky=E)
    ent_nhelpers  .grid (row=5, column=2, sticky=W)
    lb3_nhelpers  .grid (row=5, column=3, sticky=W)
    lbl_modcods   .grid (row=6, column=0, sticky=E)
    lb2_modcods   .grid (row=6, column=1, sticky=E)
    ent_modcods   .grid (row=6, column=2, sticky=W)
    lb3_modcods   .grid (row=6, column=3, sticky=W)
    lbl_framesizes.grid (row=7, column=0, sticky=E)
